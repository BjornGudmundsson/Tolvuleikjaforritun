...
function Rock() {
    ...
    this.cx = randomNumberBetween(0, w); // CHANGE THIS
    this.cy = randomNumberBetween(0, h); // CHANGE THIS
    this.rotation = 0;
    ...
    var xVel = util.randRange(MIN_SPEED, speed);
    var yVel = Math.sqrt(util.square(speed) - util.square(xVel));
    this.velX = xVel/SECS_TO_NOMINALS; // CHANGE THIS
    this.velY = yVel/SECS_TO_NOMINALS; // CHANGE THIS
